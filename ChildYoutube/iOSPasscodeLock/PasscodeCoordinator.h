...
static NSString *TrackingInactivityStartedNotification = @"TrackingInactivityStarted";
static NSString *TrackingInactivityEndedNotification = @"TrackingInactivityEnded";
static NSString *PasscodeLockedNotification = @"PasscodeLocked";
static NSString *PasscodeDismissedNotification = @"PasscodeDismissed";
